...
public class WebTables3 {
    ...
    public static void main(String[] args) {
        ...
        //Find the largest value in 1hr change column from the dynamic table where crypto prices are changing
        ...
        String xpathDynmic = "//table[@class='lcw-table layout-fixed']//tr["+(indexOfMax+1)+"]//div[@class='filter-item-name mb0 text-left']";
        System.out.println("The name of the crypto that has the biggest change is: "  +  driver.findElement(By.xpath(xpathDynmic)).getText());
